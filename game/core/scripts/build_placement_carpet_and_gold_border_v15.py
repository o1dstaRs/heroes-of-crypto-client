...
SOURCE = Path(
    ...
    "exec-951cc471-fa15-4626-aff2-66269123d9a0.png"
)
SOURCE_CROP = (35, 2, 790, 1901)
...
def main() -> None:
    ...
    source.save(DESIGN_DIR / "green_carpet_uniform_thin_gold_imagegen_source_v15.png")
    ...
    for columns, width in CONFIGS:
        ...
        carpet_path = ASSET_DIR / f"placement_carpet_green_uniform_gold_{columns}col_v15.webp"
        output.save(carpet_path, "WEBP", lossless=True, method=6)

        border_path = ASSET_DIR / f"placement_gold_outer_border_{columns}col_v15.webp"
