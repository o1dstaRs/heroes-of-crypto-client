 ...
 * Left-screen HD cutouts were authored and tuned around their own neutral (1×, 0/0) canvas; multiplying
 * them by the pick-card's often 3–4× crop is what produced the oversized Wolf Rider regression.
 */
