...
export const SYNERGY_NAME_TO_DESCRIPTION = {
    ...
    "Chaos:2:1": "{}% chance to apply Break on attack which disables enemy abilities for 2 turns",
    "Chaos:1:2": "Improves movement steps by {} cells",
    "Chaos:2:2": "{}% chance to apply Break on attack which disables enemy abilities for 2 turns",
    "Chaos:1:3": "Improves movement steps by {} cells",
    "Chaos:2:3": "{}% chance to apply Break on attack which disables enemy abilities for 2 turns",
