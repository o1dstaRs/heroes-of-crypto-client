...
export const LEFT_SIDEBAR_ART_SCALE_MAX = 3;
...
export const LEFT_SIDEBAR_PORTRAIT_CHECKPOINT_X: Readonly<Partial<Record<number, LeftSidebarPortraitTuning>>> =
    Object.freeze({
        ...
        3: { artScale: 0.97, artOffsetX: 18, artOffsetY: 2, containerWidth: 99, containerOffsetX: 1 },
        ...
        13: { artScale: 0.78, artOffsetX: 4, artOffsetY: -76, containerWidth: 99, containerOffsetX: 1 },
        14: { artScale: 0.76, artOffsetX: 2, artOffsetY: -15, containerWidth: 99, containerOffsetX: 1 },
        15: { artScale: 0.7, artOffsetX: -6, artOffsetY: -40, containerWidth: 99, containerOffsetX: 1 },
        ...
        24: { artScale: 0.85, artOffsetX: -25, artOffsetY: 4, containerWidth: 99, containerOffsetX: 1 },
        ...
        35: { artScale: 0.82, artOffsetX: -21, artOffsetY: 49, containerWidth: 99, containerOffsetX: 1 },
        36: { artScale: 0.86, artOffsetX: -24, artOffsetY: 6, containerWidth: 99, containerOffsetX: 1 },
        ...
        51: { artScale: 3, artOffsetX: -41, artOffsetY: 20, containerWidth: 99, containerOffsetX: 1 },
        ...
        55: { artScale: 0.73, artOffsetX: -3, artOffsetY: 12, containerWidth: 99, containerOffsetX: 1 },
...
// The prepared left-screen WebPs use their own neutral editor namespace. Legacy tuning remains in its
// previous localStorage keys but must not be inherited by this surface-specific asset set.
export const LEFT_SIDEBAR_PORTRAIT_TUNING_STORAGE_KEY = "hoc-dev-left-screen-portrait-tuning-v1";
