...
/** Start with both setup tools visible; the sidebar measures the actual layout before keeping this default. */
...
/** A one-pixel tolerance avoids folding a panel for fractional browser-layout rounding. */
