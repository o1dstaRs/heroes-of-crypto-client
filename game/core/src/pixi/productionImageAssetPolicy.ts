...
const UNUSED_PRODUCTION_ASSETS = new Set([
    ...
    // Spell names are live Pixi text now. These source strips and unused frame/badge alternatives have
    // no selector or dynamic key path, so production should not copy or decode them.
    "dismorale_font",
    "heal_font",
    "riot_font",
    "sadness_font",
    "visible_font",
    "weapon_rune_font",
    "wild_regeneration_font",
    "wind_flow_font",
    "spell_inner_frame_option4",
    "spell_scroll_badge",
    // Retired effect art with no matching current spell, ability, effect, or aura configuration.
    "fire_vulnerability_256",
    "made_of_bones_256",
    "poison_cloud_aura_256",
    "serene_mind_256",
    "taxpayer_256",
    "spider_512",
    "stun_status_gold",
