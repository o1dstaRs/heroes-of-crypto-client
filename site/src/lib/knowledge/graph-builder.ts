...
const synergySpecs: SynergySpec[] = [
    {
        ...
        detail: `Applied once, when the fight starts: every stack's size is multiplied and rounded down, so small stacks gain nothing — at level 1 the first extra creature needs 17 in the stack, at level 2 nine, at level 3 six — and level-4 stacks of 1–3 creatures never grow. Creatures summoned later get nothing. At level 3: ${supplyExamples()}. It is worth most to armies of big low-level stacks. At level 3 it also moves stack power for everyone: a stack grown past 1,250 experience (Monk, Unicorn, Zena, Pegasus, Cyclops) becomes the board's strongest, so exact-1,000 stacks in both armies — unsplit level-4 stacks, Battle Mages, Magic Dragons — drop to stack power 4 and can't use what needs 5 (Meteorite, Meteor Shower, Wind Flow).`,
        detailRu: `Применяется один раз, в начале боя: размер каждого стека умножается и округляется вниз, поэтому маленькие стеки ничего не получают — на уровне 1 первое лишнее существо появляется при 17 в стеке, на уровне 2 — при 9, на уровне 3 — при 6, — а стеки 4 уровня из 1–3 существ не растут никогда. Призванные позже существа ничего не получают. На уровне 3: ${supplyExamples()}. Больше всего она даёт армиям из больших стеков низкого уровня. На 3 уровне она меняет силу стека для всех: стек, выросший больше 1250 опыта (Monk, Unicorn, Zena, Pegasus, Cyclops), становится сильнейшим на поле, и стеки ровно на 1000 опыта в обеих армиях — неразделённые стеки 4 уровня, Battle Mage, Magic Dragon — опускаются до силы 4 и теряют то, что требует 5 (Meteorite, Meteor Shower, Wind Flow).`,
    ...
    return [
        ...
        },
        {
            ...
            text: [
                ...
                "#### Movement is damage\nRapid Charge adds its per-cell percentage for every cell of the charge: 10% per cell at full stack, 20% at +10 luck, 32% with Abilities power level 3 too — a 6-cell charge is ×1.6, ×2.2 or ×2.92. Everything that lengthens the route — the Movement augment, Swift Boots (+25%, applied after the augment), Chaos Movement, Crown of Command, Wolf Trail, Tie up the Horses, Battle Roar — is a damage bonus for the Wolf Rider, Nomad and Champion, and the Champion's Crusade adds +0.5 attack and armor per cell walked (up to 50). Attacks only, not retaliations.",
                "#### Artifacts that reward a build\n- Hunter's Longbow: +1 base attack per ranged stack, added after the Sniper augment's percentage — with 5 ranged stacks an Arbalester goes 7 → 12 (+71%), a Tsar Cannon only 46 → 51 (+11%). It is an artifact for swarms of cheap shooters.\n- Farsight Quiver, Guiding Winds and the Sniper augment's range do nothing for the Arbalester (its Sniper ability already ignores falloff); they matter for short-range shooters — a Centaur's 4 cells become 6 with Farsight Quiver and 8 with Sniper level 3 as well.\n- Tome of Amplification strengthens every numbered buff your units cast on your own side: Riot 30 → 45%, Mass Riot 25 → 37.5%, Magic Mirror 40 → 60%, Mass Magic Mirror 32 → 48%, Battle Roar +1 → +1.5 movement — and Wind Flow, which then gives your own flyers +6 armor but −6 movement (enemy flyers keep ±4): cast it only once your flyers are in position.\n- Fireforged Sword burns every unit the hit damaged, each for 20% of its own damage (30% with Tome), so it is worth most on attackers that hit many units: Tsar Cannon (Through Shot), Gargantuan and Cyclops (area), Zena (Chakram).\n- Rallying Volley (Zena) gives each ranged stack within 2 cells +2 shots once: Tsar Cannon and Centaur 4 → 6, Orc 6 → 8; every split stack gets its own +2.\n- Pegasus Might's flat +2 attack and armor comes before the percentage bonuses, so it matters most on level-1 stacks: a Peasant's 9/7 becomes 11/9 (+22%/+29%), a Black Dragon's 48/40 barely moves.\n- Giant's Maul multiplies physical area damage on every unit hit — your own stacks in the ring of your Area Throw or Large Caliber included (a Tsar Cannon there takes ×1.4 × 1.5 = ×2.1), so keep them out of the 3×3 around your own targets.",
                "#### Augments\nThe Armor augment's magic resistance points are added to the base, and Magic Shield, Wardguard, Warding Mane and Arcane Ward then combine as separate rolls: a Frenzied Boar's 36% becomes 68% with Magic Shield, 76% with Warding Mane and 78.4% with Arcane Ward. Might (+8/17/27% base attack) works on every unit whose selected attack isn't a shot — melee units, casters and shooters switched to melee — while Sniper helps shooters only while they shoot; an engaged shooter loses both Sniper and Hunter's Longbow, but Centaur and Zena (Handyman) keep hitting at full strength in melee and profit from Might.",
                "#### Spells\nBlessing and Battle Roar force the top damage roll, so they are worth most on units with a wide damage range — about +60% for a Scavenger, +43% for Wolf, Orc and Battle Mage, +33% for Black Dragon and Troll, but only +5–6% for Pikeman and Griffin; Curse hurts the wide-range units most. No spell from either side reaches a Black Dragon (Enchanted Skin) — not even your own buffs or Wind Flow — while auras, blessings, artifacts and augments do, so its Fire Breath grows only through the Empower augment, Mage's or Archmage's Ring and Sylvan Focus. Life's Supply synergy grows casters whose spells scale with creature count: at level 3 a Healer stack 40 → 47 heals 200 → 235, Battle Mages 50 → 59 cast Fire Strike for 300 → 354, Wandering Mages 164 → 195 throw Fireball for 328 → 390, Satyrs 36 → 42 summon 54 → 63 Wolves; two-creature level-4 casters don't grow.",
                "#### Anti-synergies and traps\n- Life's Supply at level 3 grows some stacks past 1,250 experience (Monk 1,278, Unicorn 1,274, Zena 1,269, Pegasus 1,261, Cyclops 1,260), and every stack at 80% of that or less drops to stack power 4 — in both armies: unsplit level-4 stacks, Battle Mages and Magic Dragons (exactly 1,000), a Valkyrie (1,018) next to a grown Monk or Unicorn. Meteorite, Meteor Shower and Wind Flow need stack power 5 and can't be cast then: a free debuff against a level-4-heavy army, a trap next to your own Magic Dragon.\n- Morale is capped at ±20. With Life's Morale and Luck synergy at level 3 (+20), Crown of Command's +8 morale is wasted on Life, Might and Nature creatures (Chaos ones gain +1) — take it for its movement and armor — and Cursed Ward's −6 costs only 2/4/5/6 morale by faction, while its +3 luck is mostly lost to the +10 luck cap.\n- Madness and Mechanism units (Troglodyte, Tsar Cannon) sit at 0 morale, so morale sources do nothing for them; the Tsar Cannon also can't be healed.\n- Chaos's Break on Attack is best aimed at blessing and aura carriers: a Broken carrier stops counting, so its Warding Mane, Arcane Ward, Arrows Wingshield or Angelic Host vanishes from the whole army unless another unbroken carrier lives, and a Broken unit projects no auras. A second Squire stack keeps Arcane Ward alive through a Break.",
                "#### Summons and synergy level\nThe synergy level is taken at fight start and can only rise: a summon adds its creature, so an Infest kill (an Arachna Spider appears) or Summon Wolves without a drafted Wolf can move Nature from 5 to 6 different creatures — level 2 → 3 — mid-fight. It matters when the match drew Nature's Flying Armor variant (24% → 35% armor for every flyer)."
            ].join("\n\n"),
            textRu: [
                ...
                "#### Deep Wounds, удача и много атакующих\nКаждый удар в ближнем бою юнита с Deep Wounds добавляет к ранам цели (значение карты ÷ 5 × сила стека) + удача + синергия Силы «Сила способностей», а каждый атакующий с картой Deep Wounds наносит сумму ран как дополнительный урон в процентах. Удача входит целиком, поэтому на маленьких картах она даёт больше самой карты: 6 за удар у Wolf становятся 16 при удаче +10 (Luck Aura у Leprechaun ставит союзникам в радиусе 2 клеток ровно +10) и 28 вместе с «Силой способностей» 3 уровня; карты 2 уровня (Griffin, White Tiger, Manticore) — 13 → 23, у Behemoth — 21 → 31. Double Punch у Wolf кладёт две раны за одну атаку: второй удар уже считается с раной, которую нанёс первый. Wounding Charm даёт каждому юниту карту 1 уровня, так что каждый атакующий и добавляет раны, и пользуется ими.",
                "#### Удача и ауры\nПроцентные ауры прибавляют удачу своего носителя и синергию «Сила способностей» целиком: при удаче +10 и «Силе способностей» 3 уровня Sharpened Weapons растёт с 18 до 40% базовой атаки союзников ближнего боя, War Anger — с 10 до 32% за каждый вражеский стек рядом, Absorb Penalties — с 50 до 72% (Guiding Winds и Sylvan Focus берут удачу, но не синергию). Поэтому Leprechaun рядом с носителем ауры усиливает ауру для всех союзников в ней — а его Luck Aura действует и на него самого: Lucky Strike идёт от 50% шанса на +50% (в среднем около ×1,25) до 62% на +62% с «Силой способностей» 3 уровня.",
                "#### Правила аур\nАуры с одинаковым названием не складываются: каждая клетка берёт сильнейший источник. Плоские ауры не зависят от силы стека — Luck, Range Null Field, Web, Pegasus Might (+2), Tie up the Horses (+2), Venom Cloud (20%), Rallying Volley (+2 выстрела), Sylvan Focus, благословения Angelic Host и Arcane Ward, — поэтому разделённый носитель даёт их в полную силу в двух местах (остальные его способности от силы стека после разделения слабеют). Ауры от силы стека (Sharpened Weapons, War Anger, Absorb Penalties, Wolf Trail, Guiding Winds, Flesh Shield; благословения Warding Mane и Arrows Wingshield) при разделении слабеют — таких носителей держите целыми. Синергия Силы «Радиус аур» добавляет 1/2/3 клетки каждой ауре, в том числе направленной на врага: зона носителя 2×2 растёт с 6×6 до 12×12 — 144 из 256 клеток поля — на 3 уровне, и Range Null Field у Griffin или Web у Arachna Queen накрывают полполя; заодно растёт зона обнаружения Disguise у White Tiger (8×8 → 14×14), и Tiger куда чаще видим. Flesh Shield выгоднее всего на хрупких союзниках: забранная доля пересчитывается против брони Abomination (45), поэтому стрелка с низкой бронёй он спасает куда сильнее, чем танка.",
                "#### Контроль и ответы\nUnicorn: One in the Field отвечает на каждую атаку в ближнем бою, а не только на первую за круг, и каждый ответ бросает Blindness — 25% при полной силе, 37% с «Силой способностей» 3 уровня, 47% ещё и с удачей +10; ослеплённый атакующий пропускает 2 хода и теряет второй удар Double Punch. Бейте его стрелками, заклинаниями или юнитами с иммунитетом к Разуму (Madness, Mechanism); Helm of Focus снижает шанс в 0,65 раза. Pikeman: Aggr (50% при полной силе) заставляет цель отвечать на круг только ему, поэтому все остальные союзники бьют её без ответа, а Skewer Strike бросает весь набор эффектов удара и по юниту позади — одна атака может связать два стека; ходите Pikeman первым. Stun, Blindness и Freeze не обновляются, пока действуют, а разные эффекты убывают одновременно, поэтому Stun на уже ослеплённом стеке пропадает зря — распределяйте контроль по разным целям.",
                ...
                "#### Движение — это урон\nRapid Charge добавляет свой процент за каждую клетку разбега: 10% за клетку при полной силе, 20% при удаче +10, 32% ещё и с «Силой способностей» 3 уровня — разбег на 6 клеток даёт ×1,6, ×2,2 или ×2,92. Всё, что удлиняет путь, — апгрейд «Движение», Swift Boots (+25%, после апгрейда), синергия Хаоса «Передвижение», Crown of Command, Wolf Trail, Tie up the Horses, Battle Roar — это бонус к урону для Wolf Rider, Nomad и Champion, а Crusade у Champion добавляет +0,5 к атаке и броне за каждую пройденную клетку (до 50). Только в атаке, не в ответах.",
                "#### Артефакты под сборку\n- Hunter's Longbow: +1 к базовой атаке за каждый стек стрелков, прибавляется после процента апгрейда «Стрельба» — при 5 стеках стрелков Arbalester растёт с 7 до 12 (+71%), а Tsar Cannon — лишь с 46 до 51 (+11%). Это артефакт для стай дешёвых стрелков.\n- Farsight Quiver, Guiding Winds и дальность апгрейда «Стрельба» ничего не дают Arbalester (его Sniper и так отменяет штраф за дальность); они важны стрелкам с короткой дистанцией — 4 клетки Centaur становятся 6 с Farsight Quiver и 8 ещё и со «Стрельбой» 3 уровня.\n- Tome of Amplification усиливает каждый числовой бафф, который ваши юниты накладывают на свою сторону: Riot 30 → 45%, Mass Riot 25 → 37,5%, Magic Mirror 40 → 60%, Mass Magic Mirror 32 → 48%, Battle Roar +1 → +1,5 к движению — и Wind Flow, который тогда даёт вашим летающим +6 к броне, но −6 к движению (вражеские остаются при ±4): применяйте его, только когда ваши летающие уже на месте.\n- Fireforged Sword поджигает каждого юнита, которому удар нанёс урон, на 20% его собственного урона (30% с Tome), поэтому он лучше всего на атакующих, бьющих многих: Tsar Cannon (Through Shot), Gargantuan и Cyclops (по площади), Zena (Chakram).\n- Rallying Volley (Zena) даёт каждому стеку стрелков в радиусе 2 клеток +2 выстрела один раз: Tsar Cannon и Centaur 4 → 6, Orc 6 → 8; каждый разделённый стек получает свои +2.\n- Плоские +2 к атаке и броне от Pegasus Might прибавляются до процентных бонусов, поэтому важнее всего на стеках 1 уровня: 9/7 у Peasant становятся 11/9 (+22%/+29%), а 48/40 у Black Dragon почти не меняются.\n- Giant's Maul умножает физический урон по площади по каждому поражённому — включая ваши стеки в кольце вашего Area Throw или Large Caliber (Tsar Cannon там получает ×1,4 × 1,5 = ×2,1), поэтому держите их вне 3×3 вокруг своих целей.",
                "#### Апгрейды\nОчки сопротивления магии от апгрейда «Броня» прибавляются к базе, а Magic Shield, Wardguard, Warding Mane и Arcane Ward затем складываются как отдельные броски: 36% у Frenzied Boar становятся 68% с Magic Shield, 76% с Warding Mane и 78,4% с Arcane Ward. «Сила» (+8/17/27% к базовой атаке) действует на каждого юнита, чья выбранная атака — не выстрел: юнитов ближнего боя, заклинателей и стрелков, переключённых в ближний бой, — а «Стрельба» помогает стрелкам, только пока они стреляют; связанный боем стрелок теряет и «Стрельбу», и Hunter's Longbow, но Centaur и Zena (Handyman) бьют в ближнем бою в полную силу и получают пользу от «Силы».",
                "#### Заклинания\nBlessing и Battle Roar заставляют выпасть максимальный урон, поэтому они ценнее всего на юнитах с широким разбросом урона — около +60% у Scavenger, +43% у Wolf, Orc и Battle Mage, +33% у Black Dragon и Troll, и всего +5–6% у Pikeman и Griffin; Curse сильнее всего бьёт по юнитам с широким разбросом. Ни одно заклинание обеих сторон не действует на Black Dragon (Enchanted Skin) — даже ваши баффы и Wind Flow, — а ауры, благословения, артефакты и апгрейды действуют, поэтому его Fire Breath растёт только от апгрейда «Магия», Mage's или Archmage's Ring и Sylvan Focus. Синергия Жизни «Запас» растит заклинателей, чьи заклинания зависят от числа существ: на 3 уровне стек Healer 40 → 47 лечит на 200 → 235, Battle Mage 50 → 59 бьют Fire Strike на 300 → 354, Wandering Mage 164 → 195 бросают Fireball на 328 → 390, Satyr 36 → 42 призывают 54 → 63 Wolf; заклинатели 4 уровня из двух существ не растут.",
                "#### Антисинергии и ловушки\n- Синергия Жизни «Запас» на 3 уровне растит некоторые стеки больше 1250 опыта (Monk 1278, Unicorn 1274, Zena 1269, Pegasus 1261, Cyclops 1260), и каждый стек, у которого 80% этого или меньше, опускается до силы 4 — в обеих армиях: неразделённые стеки 4 уровня, Battle Mage и Magic Dragon (ровно 1000), Valkyrie (1018) рядом с выросшим Monk или Unicorn. Meteorite, Meteor Shower и Wind Flow требуют силы стека 5 и тогда недоступны: бесплатный дебафф против армии из юнитов 4 уровня и ловушка рядом с вашим же Magic Dragon.\n- Мораль ограничена ±20. С синергией Жизни «Мораль и удача» 3 уровня (+20) мораль +8 от Crown of Command пропадает у существ Жизни, Силы и Природы (у Хаоса остаётся +1) — берите его ради движения и брони, — а −6 от Cursed Ward стоят лишь 2/4/5/6 морали в зависимости от фракции, при этом его +3 к удаче в основном срезаются пределом удачи +10.\n- Юниты с Madness и Mechanism (Troglodyte, Tsar Cannon) всегда при морали 0, так что источники морали им ничего не дают; Tsar Cannon к тому же нельзя лечить.\n- «Разлом при атаке» Хаоса лучше всего направлять на носителей благословений и аур: носитель под Break перестаёт учитываться, и его Warding Mane, Arcane Ward, Arrows Wingshield или Angelic Host пропадает у всей армии, если нет другого живого носителя без Break, а юнит под Break не даёт аур. Второй стек Squire сохраняет Arcane Ward при Break.",
                "#### Призывы и уровень синергии\nУровень синергии берётся в начале боя и может только расти: призыв добавляет своё существо, поэтому убийство через Infest (появляется Arachna Spider) или Summon Wolves без задрафтованного Wolf может поднять Природу с 5 до 6 разных существ — с уровня 2 до 3 — прямо в бою. Это важно, если в матче выпал вариант синергии Природы «Броня летающих» (24% → 35% брони каждому летающему)."
            ].join("\n\n"),
