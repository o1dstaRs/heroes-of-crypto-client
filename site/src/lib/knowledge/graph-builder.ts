    ...
    for (const spec of synergySpecs) {
        ...
        graph.add({
            ...
            text: [
                ...
                `The bonus applies to every unit in your army, whatever its faction. The level is the number of different creatures of the faction ÷ 2, rounded down (3 creatures still give level 1), locked when the fight starts — losses never lower it — and a creature summoned mid-fight that is new to your army can raise it. A draft brings exactly six creatures (2/2/1/1), so level 3 means every drafted creature belongs to this faction.`,
