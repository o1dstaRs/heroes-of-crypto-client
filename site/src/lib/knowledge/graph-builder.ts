    ...
    return [
        ...
        },
        {
            ...
            textRu: [
                ...
                "#### Удача и ауры\nПроцентные ауры прибавляют удачу своего носителя и синергию «Сила способностей» целиком: при удаче +10 и «Силе способностей» 3 уровня Sharpened Weapons растёт с 18 до 40% базовой атаки союзников ближнего боя, War Anger — с 10 до 32% за каждый вражеский стек рядом, Absorb Penalties — с 50 до 72% (Guiding Winds и Sylvan Focus берут удачу, но не синергию; Venom Cloud — это ровно 20% плюс удача союзника, наносящего удар, так что удача самой Wyvern не важна). Поэтому Leprechaun рядом с носителем ауры усиливает ауру для всех союзников в ней — а его Luck Aura действует и на него самого: Lucky Strike идёт от 50% шанса на +50% (в среднем около ×1,25) до 62% на +62% с «Силой способностей» 3 уровня. Удача делает безопасным и Craft у Blacksmith: шанс оглушить себя — 10% минус удача, так что при +10 он не срабатывает против вас, а шанс Frozen растёт до 20%.",
                ...
                "#### Движение — это урон\nRapid Charge добавляет свой процент за каждую клетку разбега, считая клетку старта: 10% за клетку при полной силе, 20% при удаче +10, 32% ещё и с «Силой способностей» 3 уровня — 6 пройденных клеток считаются как 7, то есть ×1,7, ×2,4 или ×3,24. Только в атаке, не в ответах. Всё, что удлиняет путь, — апгрейд «Движение», Swift Boots (+25%, после апгрейда), синергия Хаоса «Передвижение», Crown of Command, Wolf Trail, Tie up the Horses, Battle Roar — это бонус к урону для Wolf Rider, Nomad и Champion, а Crusade у Champion навсегда добавляет +0,5 к атаке и броне за каждую пройденную клетку (до 50).",
