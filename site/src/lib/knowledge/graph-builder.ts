    ...
    return [
        ...
        },
        {
            ...
            text: [
                ...
                "#### Stack power\nA 1–5 rating of a stack's experience × creatures alive against the strongest stack on the board; it scales abilities and auras and gates some spells. An unsplit drafted stack starts at 5.",
            ...
            textRu: [
                ...
                "#### Сила стека\nОценка 1–5: опыт × живые существа стека относительно сильнейшего стека на поле; масштабирует способности и ауры и открывает часть заклинаний. Неразделённый задрафтованный стек начинает с 5.",
