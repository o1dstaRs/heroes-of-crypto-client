    ...
    return [
        ...
        },
        {
            ...
            textRu: [
                ...
                "#### Ответные удары\nСтек отвечает раз за круг, поэтому дешёвый первый удар забирает ответ до того, как пойдёт главный атакующий (кроме One in the Field); на атаки с Shadow Touch и Lightning Spin не отвечают; оглушённый, ослеплённый или замороженный защитник ответить не может; на заклинания не отвечают никогда.",
        ...
        },
        {
            ...
            text: bullet([
                ...
                `The first three waves add up to 150%, so a stack that faces them all dies to wave 3 unless Resurrection returned creatures (a Water Shield can only ever take wave 1, and waves 2 and 3 alone are 125%); wave 4 destroys everything left, so a fight still running at lap ${lastWave} is a draw. Armies that lose their last stacks to the same wave draw; a stack down to half its starting creatures already dies to wave 2.`,
            ]),
            textRu: bullet([
                ...
                `Первые три волны вместе — это 150%, поэтому стек, встретивший их все, гибнет от третьей, если Resurrection не вернул существ (Water Shield может принять только первую волну, а вторая и третья вместе — уже 125%); четвёртая уничтожает всех оставшихся, так что бой, доживший до ${lastWave}-го круга, — ничья. Армии, потерявшие последние стеки от одной волны, играют вничью; стек, у которого осталась половина начальных существ или меньше, гибнет уже от второй волны.`,
            ]),
