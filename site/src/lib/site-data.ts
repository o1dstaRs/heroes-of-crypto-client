...
export const content = {
    ...
    ru: {
        ...
        profile: {
            ...
            goldKindBetPlaced: "Ставка сделана",
            goldKindBetPayout: "Ставка выиграна",
            goldKindBetRefund: "Ставка возвращена",
