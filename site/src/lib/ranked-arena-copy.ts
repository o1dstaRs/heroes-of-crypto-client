...
export const rankedArenaCopy = {
    en: {
        ...
        marketTotal: "Total",
        marketBets: "{n} predictions",
        marketPredict: "Predict",
        marketBetOn: "Predict a win for",
        marketSignInHint: "Pick a side and sign in. Predictions use {currency}.",
        marketPlace: "Predict",
        marketPlacing: "Placing…",
        marketCancel: "Cancel",
        marketAmountPlaceholder: "Amount · {currency}",
        marketPreview: "{stake} on {side} returns {total} (+{profit} profit) at the current pools.",
        marketPreviewHint: "Pick a side and an amount to see the payout.",
        marketRules:
            "One prediction per game, final once made. No commission — winners split the losing pool. A draw forfeits every prediction.",
        marketYourBet: "Your prediction: {amount} on {side}",
    ...
    ru: {
        ...
        marketTotal: "Всего",
        marketBets: "прогнозов: {n}",
        marketPredict: "Прогноз",
        marketBetOn: "Прогноз на победу",
        marketSignInHint: "Выберите сторону и войдите. Валюта прогнозов: {currency}.",
        marketPlace: "Сделать прогноз",
        marketPlacing: "Отправляем…",
        marketCancel: "Отмена",
        marketAmountPlaceholder: "Сумма · {currency}",
        marketPreview: "Прогноз {stake} на {side} вернёт {total} (+{profit} прибыли) при текущих пулах.",
        marketPreviewHint: "Выберите сторону и сумму, чтобы увидеть выплату.",
        marketRules:
            "Один прогноз на игру, изменить нельзя. Без комиссии — победители делят проигравший пул. При ничьей прогнозы не возвращаются.",
        marketYourBet: "Ваш прогноз: {amount} на {side}",
