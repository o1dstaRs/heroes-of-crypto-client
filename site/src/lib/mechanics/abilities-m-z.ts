...
export const ABILITY_NOTES_M_Z: Readonly<Record<string, NoteSpec>> = {
    ...
    "Shadow Touch": {
        en: () =>
            "Its attacks are never answered: the target can't retaliate — unless it is Broken, which switches this off for 2 laps.",
        ru: () =>
            "На его атаки никогда не отвечают: цель не может нанести ответный удар — если только он не под Break, который отключает это на 2 круга.",
    },
