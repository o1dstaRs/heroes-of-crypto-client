...
```
bun .Codex/skills/artifact-tier-list/scripts/build_report.ts <summary.json> <out.html> \
...
```
bun .Codex/skills/artifact-tier-list/scripts/build_units_report.ts <summary.json> <out.html> \
